<head>
           <a href="http://localhost:8000/consultingServices.html">BACK</a>
      <style>
            body{
    ...
    <body>
        <div class="form">
            <form name="intCalc" method="post" action="ebus2.php">
                <h1><center><font face="Castellar" color="white"><u>Please choose a consulting service</u></center></h1>
                <hr />
                <center>
                     <font face="Gadugi" size="5" >
